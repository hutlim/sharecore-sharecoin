...
### Download the Blockchain from the SharecoinNode Project

The Sharecoin node project provides multiple and regulaly updated direct-link downloads. Copies of bootstrap.dat can be downloaded directly from servers provided by SharecoinNode, or be downloaded from a randomly selected server. All copies of boootstrap are updated at the maximum of every six months.

**Copies of Bootstrap from a specific server**

* [http://mango.shifinity.com/bootstrap.dat](http://mango.shifinity.com/bootstrap.dat)
* [http://apple.shifinity.com/bootstrap.dat](http://apple.shifinity.com/bootstrap.dat)

**Randomly selected dopy of Bootstrap**

This could be useful for use in scripts.

* [http://bootstrap.shifinity.com/bootstrap.dat](http://bootstrap.shifinity.com/bootstrap.dat)
	
**Example usage in a (bash) Terminal**

	wget http://bootstrap.shifinity.com/bootstrap.dat       //downloads bootstrap into current directory
